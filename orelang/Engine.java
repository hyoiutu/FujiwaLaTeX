...
import orelang.operator.OutputOperator;
import orelang.operator.InputOperator;
...
public class Engine {
    ...
    public Engine(){
        ...
        operators.put("print", new OutputOperator());
        operators.put("input", new InputOperator());
    }
